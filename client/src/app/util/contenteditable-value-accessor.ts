/**
 * I borrowed this from https://github.com/Tinkoff/angular-contenteditable-accessor
 * I tried to fork and update angular, but it failed
 *
 * I changed it to a standalone directive
 */
import {
    AfterViewInit,
    Directive,
